  ...
  return `
    <main class="page">
      ...
      <section class="social-grid">
        <article class="social-card"><h2>Watch Room</h2><p>Watch the same content with friends, chat in sync, and share reactions together.</p><button class="primary-button">Create Room</button></article>
