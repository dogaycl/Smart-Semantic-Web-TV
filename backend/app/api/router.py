...
from app.api.routers.my_channel import router as my_channel_router
...
from app.api.routers.watch_party import router as watch_party_router
...
api_router.include_router(my_channel_router)
